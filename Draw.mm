...
- (void)_draw {
    ...
    CGFloat w = self.bounds.size.width;   // 48
    CGFloat h = self.bounds.size.height;  // 28
    self.layer.cornerRadius = h / 2.0f;  // always pill-shaped background
    if (_on) {
        // Blue pill background + white circle on right with ✓
        self.backgroundColor = [UIColor colorWithRed:0.23 green:0.51 blue:0.96 alpha:1.0];
        CGFloat d = h - 6;
        UIView *circle = [[UIView alloc] initWithFrame:CGRectMake(w - d - 3, 3, d, d)];
        circle.backgroundColor = [UIColor whiteColor];
        circle.layer.cornerRadius = d / 2;
        [self addSubview:circle];
        UILabel *ck = [[UILabel alloc] initWithFrame:circle.bounds];
        ck.text = @"✓";
        ck.textColor = [UIColor colorWithRed:0.23 green:0.51 blue:0.96 alpha:1.0];
        ck.textAlignment = NSTextAlignmentCenter;
        ck.font = [UIFont boldSystemFontOfSize:12];
        [circle addSubview:ck];
    } else {
        // Dark gray pill background + small gray circle on left
        self.backgroundColor = [UIColor colorWithRed:0.20 green:0.23 blue:0.30 alpha:1.0];
        CGFloat d = h - 6;
        UIView *circle = [[UIView alloc] initWithFrame:CGRectMake(3, 3, d, d)];
        circle.backgroundColor = [UIColor colorWithRed:0.38 green:0.42 blue:0.50 alpha:1.0];
        circle.layer.cornerRadius = d / 2;
        [self addSubview:circle];
    }
}
...
static const CGFloat kTabIconSize       = 50;
static const CGFloat kTabIconImageSize  = 26;
static const CGFloat kTabSpacing        = 10;
static const CGFloat kPillHeight        = 62;
static const CGFloat kPillSpacing       = 8;
...
- (ZXToggle *)addRow:(NSString *)label
    ...
    CGFloat togW = 50, togH = 28;
    UILabel *lbl = [[UILabel alloc] initWithFrame:CGRectMake(16, 0, w - togW - 28, kPillHeight)];
    lbl.text = label;
    ...
    if (sub) {
        UILabel *subLbl = [[UILabel alloc] initWithFrame:
            CGRectMake(16, kPillHeight - 2, w - togW - 28, 20)];
        subLbl.text = sub;
    ...
    ZXToggle *tog = [[ZXToggle alloc] initWithFrame:
        CGRectMake(w - togW - 12, (kPillHeight - togH) / 2, togW, togH)];
    tog.on = on;
